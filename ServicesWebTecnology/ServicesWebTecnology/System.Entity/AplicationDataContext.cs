...
namespace SystemQuickzal.Contexts
{
    public partial class AplicationDataContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Server=104.197.55.31;Database=challenge;Port=5432;User Id=challengeuser;Password=challengepass;");
            }
        }
